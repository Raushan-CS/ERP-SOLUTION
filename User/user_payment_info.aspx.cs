...
public partial class User_payment_info : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.QueryString.ToString().Contains("invoiceNo"))
        {
            if (!IsPostBack)
            {
                ...
                {
                    hiddenfield1.Value = Session["User"].ToString();
            ...
            using (SqlConnection con2 = new SqlConnection(ConfigurationManager.ConnectionStrings["tishcon"].ConnectionString))
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (DueAm.Text == "" && PaidAm.Text == "")
                    {
                        ...
                        //insert.Parameters.AddWithValue("@projectName", Projectname.Text);
    ...
    //========================================================== Method for calculating dues and amount paid after current payment===========================================================================================
    ...
    protected void Submit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //{
                ...
                ScriptManager.RegisterStartupScript(this, typeof(string), "MessageBox", "alert('Payment Added Successfully'); window.location='user_payment_info.aspx?invoiceNo=" + recipno.Text + "';", true);
    ...
    //========================================================== Method for clearing entered values===========================================================================================
