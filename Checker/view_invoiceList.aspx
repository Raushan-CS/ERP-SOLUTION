<%@ Page Title="" Language="C#" MasterPageFile="~/Checker/CheckerMasterPage.master" AutoEventWireup="true" CodeFile="view_invoiceList.aspx.cs" Inherits="Checker_view_invoiceList" %>
                ...
                <div class="container-fluid px-4">
                   ...
                   <div class="col-sm-2" style="display:flex;flex-direction:row;">
                    ...
                    <div class="col-sm-4" style="display:flex;flex-direction:row;">
                       ...
                       <%-- <div class="col-sm-4" style="display:flex;flex-direction:row;">
                        <asp:Label ID="Label1" runat="server" Text="From" style="margin-right:10px;"></asp:Label>
                            <asp:TextBox ID="ValidityCheckFrom" runat="server" style="width:200px;margin-right:50px;margin-bottom:25px;" class="form-control" placeholder="Search By Id" TextMode="Date">
                        </asp:TextBox>
                            <asp:Label ID="Label2" runat="server" Text="To" style="margin-right:10px;"></asp:Label>
                            <asp:TextBox ID="ValidityCheckTo" runat="server" style="width:200px;margin-right:50px;margin-bottom:25px;" class="form-control" placeholder="Search By Id" TextMode="Date">
                        </asp:TextBox>
                        <asp:Button ID="ValidityCheckbt" runat="server" Text="Search" OnClick="ValidityCheckbt_Click" class="btn btn-primary" style="margin-bottom:25px;"/>
                    </div>--%>
                    <div class="col-md-12">
                                ...
                                <asp:GridView ID="GridView2" runat="server" EmptyDataText="No Bills" AutoGenerateColumns="False" CellPadding="2" CellSpacing="5" Width="100%" OnRowCommand="GridView2_RowCommand" GridLines="Both" AllowPaging="True" PageSize="25" OnPageIndexChanging="GridView2_PageIndexChanging">
                                    <Columns>
                                      ...
                                      <ItemTemplate>
                                           <%-- <a href="EditRecieptVoucher.aspx?Id=<%#Eval("Id")%>" class="btn btn-primary">Edit</a>&nbsp;|&nbsp;--%>
                                           
                                            <a href="javascript:" class="btn btn-primary" onclick='javascript:window.open("checker_view_invoice.aspx?invoiceNo=<%#Eval("invoice_no") %>","","height=1200,width=1000,left=400;top=20,status=yes,resizable=no,toolbar=no,menubar=no,location=center,scrollbars=no")'>View</a>&nbsp;&nbsp;
