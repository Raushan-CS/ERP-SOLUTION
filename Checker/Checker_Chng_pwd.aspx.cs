...
public partial class Checker_Checker_Chng_pwd : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            HiddenField2.Value = Session["Checker"].ToString();
        }
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = BL.dss("SELECT username, password FROM tbl_maker_checker WHERE username='" + HiddenField2.Value.Trim() + "'");
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                else
                {
                    ...
                    update.CommandText = "UPDATE tbl_maker_checker set password=@Password where username=@UserName";
