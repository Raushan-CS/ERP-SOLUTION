...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Create Maker/Checker</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="AdminDashboard.aspx">Home</a></li>
              <li class="breadcrumb-item active">Create Maker/Checker</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Maker/Checker Registration</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="exampleInputUserId">Mobile</label>
                  ...
                  <div class="form-group">
                    <label for="exampleInputFile">User Type</label>
                      ...
                      <asp:DropDownList ID="ddlusertype" class="form-control" runat="server">
                        ...
                        <asp:ListItem> Invoice Maker </asp:ListItem>  
                        <asp:ListItem> Invoice Checker </asp:ListItem>  
                      </asp:DropDownList>
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Maker/Checker List</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<!-- Page specific script -->
     ...
     <script type="text/javascript">
         function validate() {
             ...
             var ddlusertype = document.getElementById('<%=ddlusertype.ClientID%>').value;
