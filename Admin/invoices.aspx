<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="invoices.aspx.cs" Inherits="Admin_invoices" %>
...
<asp:Button id="btnExporttoExcel" runat="server"  OnClick="btnExporttoExcel_Click" Style="width: 200px;margin-bottom:25px;" Text="Export to Excel" class="btn btn-outline-primary" />
                    ...
                    <div class="col-md-12">
                                ...
                                <asp:GridView ID="GridView2" runat="server" EmptyDataText="No Bills" AutoGenerateColumns="False" CellPadding="2" CellSpacing="5" Width="100%"  GridLines="Both" AllowPaging="True" ShowFooter="true" PageSize="25" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowDataBound="GridView2_RowDataBound1">
                                    <Columns>
                                      ...
                                      <ItemTemplate>
                                            ...
                                            <a href="javascript:" class="btn btn-primary" onclick='javascript:window.open("view_invoices.aspx?invoiceNo=<%#Eval("invoice_no") %>","","height=1000,width=1000,left=400;top=20,status=yes,resizable=no,toolbar=no,menubar=no,location=center,scrollbars=no")'>View</a>&nbsp;|&nbsp;
                                           <a href="payment_info.aspx?invoiceNo=<%#Eval("invoice_no") %>" class="btn btn-primary">Payment</a>
