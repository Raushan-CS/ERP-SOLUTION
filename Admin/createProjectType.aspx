<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="createProjectType.aspx.cs" Inherits="Admin_createProjectType" %>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Project Type Entry</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form>
                <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputUserId">Project Type Name</label>
                                <asp:TextBox ID="txt_projectType" runat="server" class="form-control"></asp:TextBox>
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Project Type List</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<!-- Page specific script -->
     ...
     <script type="text/javascript">
         function validate() {
             ...
             var txt_projectType = document.getElementById('<%=txt_projectType.ClientID%>').value;
             

             if (txt_projectType == "") {
                 alert("Enter Project Type");
                 document.getElementById('<%=txt_projectType.ClientID%>').focus();
                 return false;
             }
