<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="payment_info.aspx.cs"
    Inherits="Admin_payment_info" %>
                        ...
                        <div class="col-md-9">
                            <div class="MainForm">
                                ...
                                <asp:TextBox ID="recipno" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                                    ...
                                    <div class="col-sm-4">
                                        <label for="bycash" class="form-label">Transaction No./Cheque No./DD No.</label>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="" EnableModelValidation="True" CellPadding="2" CellSpacing="5" Width="100%"  GridLines="Both" >
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                  <a href="javascript:" class="btn btn-primary" onclick='javascript:window.open("transaction_receipt.aspx?invoiceNo=<%#Eval("invoice_no") %>&ID=<%#Eval("ID") %> ","","height=1000,width=1000,left=400;top=20,status=yes,resizable=no,toolbar=no,menubar=no,location=center,scrollbars=no")'>View</a>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
